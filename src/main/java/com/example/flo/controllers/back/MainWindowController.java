...
public class MainWindowController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btnDons.setTextFill(Color.WHITE);
        btnFactureDons.setTextFill(Color.WHITE);
    ...
    private void afficherDons(ActionEvent ignored) {
        goToLink(Constants.FXML_BACK_DISPLAY_ALL_DON);
    ...
    private void afficherFactureDons(ActionEvent ignored) {
        goToLink(Constants.FXML_BACK_DISPLAY_ALL_FACTURE_DON);
