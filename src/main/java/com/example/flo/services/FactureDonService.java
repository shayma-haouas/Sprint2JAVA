...
public class FactureDonService {
    ...
    public List<FactureDon> getAll() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                factureDon.setAdresses(resultSet.getString("addresses"));
    ...
    public boolean add(FactureDon factureDon) {
        ...
        String request = "INSERT INTO `facture_don`(`nom_donateur`, `prenom_donateur`, `email`, `addresses`, `numero_telephone`, `description`, `don_id`) VALUES(?, ?, ?, ?, ?, ?, ?)" ;
