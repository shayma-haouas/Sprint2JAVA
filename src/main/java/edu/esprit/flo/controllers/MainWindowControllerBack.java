...
public class MainWindowControllerBack implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btnDechetss.setTextFill(Color.WHITE);
        btnReservationDechetss.setTextFill(Color.WHITE);
    ...
    private void afficherDechetss(ActionEvent ignored) {
        goToLink(Constants.FXML_BACK_DISPLAY_ALL_DECHETS);
    ...
    private void afficherReservationDechetss(ActionEvent ignored) {
        goToLink(Constants.FXML_BACK_DISPLAY_ALL_RESERVATION_DECHETS);
